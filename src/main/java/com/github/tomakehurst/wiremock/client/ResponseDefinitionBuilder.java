...
public class ResponseDefinitionBuilder {
    ...
    public ResponseDefinitionBuilder withAdditionalProxyRequestHeaders(HttpHeaders additionalRequestHeaders) {
        this.additionalRequestHeaders = ImmutableList.copyOf(additionalRequestHeaders.all());
        return this;
    }
